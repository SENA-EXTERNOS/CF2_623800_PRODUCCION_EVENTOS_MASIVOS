      ...
      .tarjeta.tarjeta--blanca.slyderA_bg_01.p-5
        SlyderA(tipo="b")
          .row
            .col-lg-8
              h4 Preproducción
              p En esa primera fase de análisis encontramos #[strong la preproducción], donde se revisan los aspectos básicos, situaciones puntuales que se van a llevar a cabo en el evento.  En muchas ocasiones se realiza un prediseño o briefing como esquema general del evento para detectar aquellos puntos neurálgicos o específicos que son la clave en el desarrollo de este
          ...
          .row
            .col-lg-8
              h4 Postproducción 
              p En la fase de postproducción, se entra a un proceso detallado de evaluación sobre todo lo que aconteció dentro del desarrollo del evento, que haya aportado a su éxito o que haya generado incertidumbre en su momento. 
