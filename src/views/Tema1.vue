...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .tarjeta.tarjeta--blanca.slyderA_bg_01.p-5
        SlyderA(tipo="b")
          ...
          .row
            .col-lg-8
              h4 Producción 
              p La fase de planeación se enfoca en #[strong la producción del evento] definiendo esta como el momento, en que basados en el objetivo del evento, se empieza a revisar toda su logística o movimiento, cada detalle que lo conforman y que hacen que se cree una identidad de este. 
              ...
              p Como coordinador está a cargo del equipo técnico y humano que está en el lugar o escenario, quienes con roles muy determinados son responsables de cada detalle del evento; Es necesario mencionar que el coordinador o el organizador del evento está al frente del mismo, desde el montaje hasta el desmontaje y sortea todos los imprevistos.
              p Por esto, contar con todos los profesionales que exija el evento, evita la incertidumbre durante la ejecución y ofrece la confianza y seguridad al cliente, de que todos sus requerimientos se cumplirán con excelencia, buscando siempre un equilibrio entre ésta y las decisiones que se deben tomar de última hora. Es importante reconocer un límite en esta toma de decisiones para evitar que el evento se caiga.
    ...
    .row.my-5
      p A continuación los diferentes tipos de producción y sus características: 
      ...
      AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta--morada")
        ...
        .row(titulo="Producción Logística ")
          ...
          .col-lg-9
            ...
            p Un aspecto importante dentro de las funciones de la producción Logística es conocer las #[strong relaciones interinstitucionales] las cuales permiten a las empresas conocer las cuestiones legislativas, políticas, reglamentarias o administrativas que les afectan directamente o a sus intereses esto si se trata de un evento empresarial público o privado. El conocer los reglamentos o políticas de la empresa en su participación de eventos permite determinar si se exigen #[strong permisos] específicos que se deban diligenciar antes o durante el evento.
            p Existen eventos como festivales musicales en que se utilizan los #[strong camerinos] lo cual ha exigido a la producción logística tener la experticia en el traslado y montaje de estos exigiendo tomar medidas de seguridad y estabilidad de la estructura.
